...
1. **Google Drive Structure**
   - Base folder (CIAA Cases): https://drive.google.com/drive/folders/1jJNOtIEfT5kXQ7CTOeVTL-6znxOTIzJe
   - Subfolders organized by fiscal year: `CIAA FY 082/083`, `CIAA FY 081/082`, etc.
   - Case folders within FY subfolders: `081-CR-0058-NITC-Network-Equipment`, etc.

2. **Local Workspace Setup**
   - Create local folder: `casework/ciaa-fy-{yy}-{yy}/{case-number}/`
   - Example: `casework/ciaa-fy-81-82/081-CR-0058/`
   - NOTE: WE MUST download all files from the Google Drive case folder to this local directory.
   - Use Google Workspace MCP tools (`mcp_workspace_*`) to access and download files
...
### Stage 2: PDF to Text Conversion

After information collection, caseworkers will coordinate with software engineers to convert PDFs to markdown text. You'll work with the converted text files in subsequent stages.

> TODO: Likhit CLI tool integration goes here.
...
- **PDF to Text**: Software engineers handle conversion
